...
void CPVRGUIInfo::UpdateMisc(void)
{
  ...
  bool       bHasTVChannels            = bStarted && g_PVRChannelGroups->GetGroupAllTV()->GetNumChannels() > 0;
  bool       bHasRadioChannels         = bStarted && g_PVRChannelGroups->GetGroupAllRadio()->GetNumChannels() > 0;
